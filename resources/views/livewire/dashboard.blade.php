            ...
            <main class="px-0 lg:px-6 py-10">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-2 py-10 lg:p-6">
                    ...
                    <div
                        ...
                        <p class="text-5xl font-extrabold text-laravel-500 dark:text-laravel-600 mt-4">
                            {{ $this->totalProjects }}</p>
                    ...
                    <div
                        ...
                        <p class="text-5xl font-extrabold text-white mt-4">{{ $notifications }}</p>
