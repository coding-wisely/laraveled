    ...
    <flux:card class="bg-gray-100 dark:bg-gray-800 shadow-md rounded-lg">
        ...
        <div class="mt-6">
            <div class="flex justify-center md:justify-start space-x-4 mt-2">
                @if($user->github)
                    <flux:link href="{{ $user->github }}" target="_blank" class="text-gray-800 dark:text-gray-200 hover:text-blue-600">
                ...
                @if($user->twitter)
                    <flux:link href="{{ $user->twitter }}" target="_blank" class="text-blue-400 hover:text-blue-500">
                        <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                            <path d="M23.444 4.834a9.167 9.167 0 0 1-2.713.772 4.775 4.775 0 0 0 2.084-2.646 9.551 9.551 0 0 1-3.01 1.187 4.75 4.75 0 0 0-8.093 4.326A13.466 13.466 0 0 1 2.83 3.58a4.75 4.75 0 0 0 1.46 6.34 4.72 4.72 0 0 1-2.15-.6v.06a4.75 4.75 0 0 0 3.8 4.66 4.743 4.743 0 0 1-2.14.08 4.75 4.75 0 0 0 4.45 3.29 9.54 9.54 0 0 1-5.94 2.04c-.385 0-.768-.023-1.15-.07a13.42 13.42 0 0 0 7.26 2.14c8.717 0 13.489-7.355 13.489-13.74 0-.21-.005-.42-.014-.63a9.774 9.774 0 0 0 2.392-2.48z"/>
                        </svg>
                    </flux:link>
                @endif
                @if($user->linkedin)
                    <flux:link href="{{ $user->linkedin }}" target="_blank" class="text-blue-800 dark:text-blue-500 hover:text-blue-600">
                        <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                            <path d="M4.98 3.5c0 1.38-1.12 2.5-2.5 2.5S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.38 8.5H5v13H.38v-13zm7.53 0h4.46v1.78h.06c.62-1.18 2.14-2.42 4.4-2.42 4.71 0 5.58 3.1 5.58 7.14v8.5h-4.65v-7.54c0-1.8-.04-4.12-2.52-4.12-2.52 0-2.91 1.97-2.91 4v7.66H7.91v-13z"/>
                        </svg>
                    </flux:link>
                @endif
            </div>
